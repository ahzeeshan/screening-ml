...
def generate_Xdata(symmetry):
	...
	scipy.io.savemat(symmetry+'-non-training-data-with-den',mdict={'mps':mps_data,'xntdata':xdata,'coord':coord_data,'volrat':volrat_data})

def generate_Xdata_old(symmetry):
	xdata = []
	mps_data = []
	volrat_data = []
	coord_data = []
